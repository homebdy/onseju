...
public class BuyOrderBookTest {
    ...
    void receiveLimitBuyOrder() {
        ...
        assertThatNoException()
                .isThrownBy(() -> buyOrderBook.add(buyOrder));
    }
    ...
    void changeOrderStatusToCompleteWhenTradeIsExecuted() {
        ...
        buyOrderBook.matchOrder(sellOrder);
    ...
    void matchSellOrderWithSamePriceBuyOrder() {
        ...
        // when
        buyOrderBook.add(buyOrder1);
        buyOrderBook.add(buyOrder2);
        Collection<MatchedEvent> responses = buyOrderBook.matchOrder(sellOrder);
    ...
    void buyOrderImbalance() {
        ...
        Collection<MatchedEvent> response = buyOrderBook.matchOrder(sellOrder);
    ...
    void receiveMarketSellOrder() {
        ...
        // when
        buyOrderBook.add(buyOrder);
        List<MatchedEvent> responses = new ArrayList<>(buyOrderBook.matchOrder(marketSellOrder));
    ...
    void isBuyOrderAboveMarketPrice() {
        ...
        boolean result = buyOrderBook.isOrderWorseThanMarket(buyOrder);
